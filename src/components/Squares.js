...
// Use this variable ONLY to initialize a slice of state!/ds'bs,mfnm
...
export default function Squares () {
  ...
  const squares = []
  listOfSquareIds.forEach(id => squares.push(id))
  useState(squares)
  ...
  const markActive = id => {
    ...
    getClassName(id) === 'active' ? setActiveSquare(null) : setActiveSquare(id)
  }
